      ...
      <div class="product-container">
        <div class="container">
          <div class="product-main">
            <h1 class="title"> C'est intérieur de Frigo qui est glacé sinon son derrière est chaud 🤣🤣. Merci beaucoup.</h1>
            ...
            <?php
              ...
              <div class="showcase">
                <div class="showcase-banner">
                  <img
                    src="./assets/images/products/<?=$row['img'] ?>"
                    alt="Mens Winter"
                    width="300"
                    class="product-img default"
                  />
                  <img
                    src="./assets/images/products/<?=$row['img2'] ?>"
                    alt="Mens Winter"
                    width="300"
                  ...
                  <div class="showcase-actions">
                    <button class="btn-action">
                      <a class="delete-link" href="add.php?id=<?=$row['id']?>" ><ion-icon name="bag-add-outline"></ion-icon></a>
                    </button>
                  </div>
                </div>
